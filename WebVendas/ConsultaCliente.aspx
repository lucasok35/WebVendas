<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="ConsultaCliente.aspx.cs" Inherits="WebVendas.ConsultaCliente" %>
        ...
        <article class="kanban-entry grab" id="item1" draggable="true">
            <div class="kanban-entry-inner">
                <div class="kanban-label">
                    <h2><a href="#">Consulta Cliente</a> <span></span></h2>
                    <p></p>
                </div>
            </div>
        </article>
